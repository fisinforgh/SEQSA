...
#define R__DICTIONARY_FILENAME SoftEduQSADict
...
namespace {
  void TriggerDictionaryInitialization_SoftEduQSADict_Impl() {
...
#line 1 "SoftEduQSADict dictionary forward declarations' payload"
...
#line 1 "SoftEduQSADict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("SoftEduQSADict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_SoftEduQSADict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_SoftEduQSADict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_SoftEduQSADict() {
  TriggerDictionaryInitialization_SoftEduQSADict_Impl();
}
