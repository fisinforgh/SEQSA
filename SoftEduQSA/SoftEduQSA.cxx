...
//Texto dentro del pad2
	...
	TPTQSAExplination->SetTextAlign(12);
	...
	TPTConsideraciones->SetTextAlign(12);
...
//Canvas de explicaciones/agradecimientos
	...
	padExp->cd();
	TPaveText *TPTAgradecimientos= new TPaveText(0.0099, 0.0099, 0.99, 0.999,"NDC"); 
	TPTAgradecimientos->SetFillColor(kCyan-10); 
	TPTAgradecimientos->SetShadowColor(kGray);
	TPTAgradecimientos->SetMargin(0.05);
 	TPTAgradecimientos->AddText("#font[62]{#scale[1.6]{Autores}}");
 	TPTAgradecimientos->AddText("#font[62]{AndresFelipe Garcia Cardenas}, Investigation Group#font[62]{FISINFOR}, Physics degree#font[62]{Universidad Distrital Francisco Jose De Caldas}");
 	TPTAgradecimientos->AddText("#font[62]{Julian A Salamanca B}, #font[62]{PHD}, Investigation Group#font[62]{FISINFOR}, Faculty of sciences and education, Teacher#font[62]{Universidad}#font[62]{Distrital Francisco Jose De Caldas.}");
...
Ayuda->cd();
	...
	TPTPaso4->AddText("");
 	...
 	TPTPaso4->AddText("On the left side of the interface, you will find the buttonsFor");
...
//Texto dentro del pad1
	...
	TPTPaso4->AddText("");
 	...
 	TPTPaso4->AddText("");
 	TPTPaso4->AddText("The measurement gates work to obtain the #font[62]{results} of the operationsFollowing");
 	...
 	TPTPaso4->AddText("a measurement means selecting one of the resulting valuesFrom the operation,");
